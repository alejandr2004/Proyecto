...
echo "<a class='btn btn-outline-primary' href='dept.php' role='button'>dept</a>";

echo "<a class='btn btn-outline-primary' href='./formularios/formulariosEmp/formCrearEmp.php' role='button'>Crear</a>";
...
echo "<td scope='col'><a class='btn btn-primary' href='./formularios/formulariosEmp/formEditarEmp.php?id=".$datos['Id_Alumne']."' role='button'>Editar</a></td> ";
echo "<td scope='col'><a class='btn btn-danger' href='./acciones/accionesEmp/eliminarEmp.php?id=".$datos['Id_Alumne']."' role='button'>Eliminar</a></td>";
echo "</tr>";
