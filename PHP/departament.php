...
echo "<td scope='col'>Id del departamento</td>";
echo "<td scope='col'>Código del departamento</td>";
echo "<td scope='col'>Nombre del departamento</td>";
...
echo "<a class='btn btn-outline-primary' href='./formularios/formulariosDepartament/formCrearDepartament.php' role='button'>Crear</a>";
...
foreach ($consulta as $posicion => $datos) {
    ...
    echo "<td scope='col'><a class='btn btn-primary' href='./formularios/formulariosDepartament/formEditarDepartament.php?id=" . $datos['Id_Dept'] . "' role='button'>Editar</a></td>";
    echo "<td scope='col'><a class='btn btn-danger' href='./acciones/accionesDepartament/eliminarDepartament.php?id=" . $datos['Id_Dept'] . "' role='button'>Eliminar</a></td>";
    echo "</tr>";
}
echo "<table>";
